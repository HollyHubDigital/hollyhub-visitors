...
app.use((req, res, next) => {
  try{
    ...
    res.setHeader('Content-Security-Policy', "default-src 'self' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://paystack.com https://js.paystack.co https://checkout.flutterwave.com https://checkout-v3-ui-prod.f4b-flutterwave.com https://cdn.jsdelivr.net https://challenges.cloudflare.com https://cdn.mxpnl.com https://static.klaviyo.com https://www.googletagmanager.com https://translate.google.com https://translate.googleapis.com https://translate-pa.googleapis.com https://www.gstatic.com https://embed.tawk.to https://widget.privy.com https://cdn.yotpo.com https://script.hotjar.com https://cdn.segment.com https://embed.typeform.com https://widget.intercom.io https://api-iam.intercom.io https://assets.freshchat.com https://wchat.freshchat.com https://js.driftt.com https://load.sumome.com; script-src-elem 'self' 'unsafe-inline' https://paystack.com https://js.paystack.co https://checkout.flutterwave.com https://checkout-v3-ui-prod.f4b-flutterwave.com https://cdn.jsdelivr.net https://challenges.cloudflare.com https://cdn.mxpnl.com https://static.klaviyo.com https://www.googletagmanager.com https://translate.google.com https://translate.googleapis.com https://translate-pa.googleapis.com https://www.gstatic.com https://embed.tawk.to https://widget.privy.com https://cdn.yotpo.com https://script.hotjar.com https://cdn.segment.com https://embed.typeform.com https://widget.intercom.io https://api-iam.intercom.io https://assets.freshchat.com https://wchat.freshchat.com https://js.driftt.com https://load.sumome.com; worker-src 'self' blob:; connect-src 'self' https: wss: https://eu.i.posthog.com https://translate.googleapis.com https://translate-pa.googleapis.com https://www.gstatic.com https://challenges.cloudflare.com https://api.flutterwave.com; frame-src 'self' https://challenges.cloudflare.com https://paystack.com https://checkout.paystack.com https://js.paystack.co https://checkout.flutterwave.com https://checkout-v3-ui-prod.f4b-flutterwave.com https://embed.tawk.to https://widget.privy.com https://assets.freshchat.com https://wchat.freshchat.com; img-src 'self' data: https:; style-src 'self' 'unsafe-inline' https: https://paystack.com https://js.paystack.co https://checkout.paystack.com https://checkout.flutterwave.com https://checkout-v3-ui-prod.f4b-flutterwave.com https://cdn.jsdelivr.net https://widget.privy.com https://cdn.yotpo.com https://script.hotjar.com https://assets.freshchat.com https://wchat.freshchat.com https://fonts.googleapis.com https://www.gstatic.com; frame-ancestors 'self' https://admin-hollyhub.vercel.app https://admin-hollyhubdigital.vercel.app;");
...
app.use((req, res, next) => {
  try{
    ...
    // Skip CSRF for public/payment endpoints like tracking, comments, checkout, and Flutterwave
    if(req.path === '/api/track' || req.path === '/api/public-settings' || req.path === '/api/checkout' || req.path === '/api/create-flutterwave-payment' || req.path === '/api/verify-flutterwave-payment' || req.path === '/api/blog/comment' || req.path === '/api/blog/like') {
      return next();
    }
