...
module.exports = async (req, res) => {
  try{
    ...
    if(req.method === 'GET'){
      ...
      if(repoOpts && repoOpts.owner && repoOpts.repo){ const f = await getFile(dataPath, { owner: repoOpts.owner, repo: repoOpts.repo, branch: repoOpts.branch, token: repoOpts.token }); return res.json(JSON.parse(f.content||'[]')); }
